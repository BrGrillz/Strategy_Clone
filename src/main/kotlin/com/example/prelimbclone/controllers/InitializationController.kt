...
@RestController
class InitializationController (@Autowired val setStrategyDetails: SetStrategyDetails, var application: Application, var decision: Decision){

    @PostMapping("/api/v1/prelimB")
    fun call(@RequestBody application: Application): Decision?{

        this.application = application
        setStrategyDetails.launch()
        //trialSelector
