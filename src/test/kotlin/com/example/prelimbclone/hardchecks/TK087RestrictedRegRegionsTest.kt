...
class TK087RestrictedRegRegionsTest{
    ...
    fun execute_fromRestrictedRegion() {
        // given
        val region = "77"
        val application = Application(persons = Person(contactAddress = ContactAddress(region = "77"), registeredAddress = RegisteredAddress(region = "03")), salesPoint = SalesPoint(sellerplaceCode = 940001, sellerplaceTown = "Грозный"))
